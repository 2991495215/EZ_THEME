...
.payment-container {
  ...
  .product-info, .order-info {
    .info-row {
      ...
      :global(body.dark-theme) &.highlight-row {
        border-color: rgba(var(--theme-color-rgb), 0.2);
        background-color: rgba(255, 255, 255, 0.055);
      }
      
      :global(body.dark-theme) &.final-row {
        border-color: rgba(var(--theme-color-rgb), 0.24);
  ...
  .action-buttons {
    ...
    .btn-back {
      background: linear-gradient(135deg, rgba(var(--theme-color-rgb), 0.14), rgba(255, 255, 255, 0.38));
      color: var(--text-color);
      flex: 1;
      ...
      &:hover:not(:disabled) {
        color: var(--theme-color);
        background: linear-gradient(135deg, rgba(var(--theme-color-rgb), 0.22), rgba(255, 255, 255, 0.5));
        border-color: rgba(var(--theme-color-rgb), 0.5);
        transform: translateY(-2px);
        box-shadow: 0 14px 30px rgba(var(--theme-color-rgb), 0.18), inset 0 1px 0 rgba(255, 255, 255, 0.75);
      }
